...
CREATE VIEW cau2_lab2.1 AS
SELECT TOP 100 * 
FROM Sanpham 
ORDER BY giaban DESC
GO

CREATE VIEW cau3_lab2.1 AS
...
CREATE VIEW cau9_lab2.1 AS
SELECT TOP 10 *
FROM Sanpham
ORDER BY giaban DESC;
GO

CREATE VIEW cau10_lab2.1 AS
